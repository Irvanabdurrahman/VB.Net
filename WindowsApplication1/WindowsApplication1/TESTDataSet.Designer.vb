...
Partial Public Class TESTDataSet
    ...
    Partial Public Class EMPLOYEEDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddEMPLOYEERow(ByVal EMP_ID As String, ByVal NAME As String) As EMPLOYEERow
            Dim rowEMPLOYEERow As EMPLOYEERow = CType(Me.NewRow,EMPLOYEERow)
            Dim columnValuesArray() As Object = New Object() {EMP_ID, NAME}
...
Namespace TESTDataSetTableAdapters
    ...
    Partial Public Class EMPLOYEETableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[EMPLOYEE] WHERE (([EMP_ID] = @Original_EMP_ID) AND ([NAME] = @"& _ 
                "Original_NAME))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[EMPLOYEE] ([EMP_ID], [NAME]) VALUES (@EMP_ID, @NAME);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT "& _ 
                "EMP_ID, NAME FROM EMPLOYEE WHERE (EMP_ID = @EMP_ID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[EMPLOYEE] SET [EMP_ID] = @EMP_ID, [NAME] = @NAME WHERE (([EMP_ID] ="& _ 
                " @Original_EMP_ID) AND ([NAME] = @Original_NAME));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT EMP_ID, NAME FROM EMP"& _ 
                "LOYEE WHERE (EMP_ID = @EMP_ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT EMP_ID, NAME FROM dbo.EMPLOYEE"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As TESTDataSet.EMPLOYEEDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As TESTDataSet.EMPLOYEEDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As TESTDataSet.EMPLOYEEDataTable = New TESTDataSet.EMPLOYEEDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As TESTDataSet.EMPLOYEEDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_EMP_ID As String, ByVal Original_NAME As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal EMP_ID As String, ByVal NAME As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal EMP_ID As String, ByVal NAME As String, ByVal Original_EMP_ID As String, ByVal Original_NAME As String) As Integer
            If (EMP_ID Is Nothing) Then
                Throw New Global.System.ArgumentNullException("EMP_ID")
            Else
            ...
            If (Original_EMP_ID Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_EMP_ID")
            Else
                Me.Adapter.UpdateCommand.Parameters(2).Value = CType(Original_EMP_ID,String)
            End If
            If (Original_NAME Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_NAME")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal NAME As String, ByVal Original_EMP_ID As String, ByVal Original_NAME As String) As Integer
            Return Me.Update(Original_EMP_ID, NAME, Original_EMP_ID, Original_NAME)
        End Function
    End Class
